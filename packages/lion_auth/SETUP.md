...
| 프로덕션 웹 | `https://lionandthelab.github.io/nest/` (origin: `https://lionandthelab.github.io`) |

**Android 서명 지문 얻기 (프롬프트에 붙여넣을 값, PowerShell):**
...
2. [API 및 서비스 > 사용자 인증 정보 > 사용자 인증 정보 만들기 > OAuth 클라이언트 ID]로
   ...
   (1) 유형: 웹 애플리케이션, 이름: "Nest Web"
       - 승인된 자바스크립트 원본: http://localhost:8080 , https://lionandthelab.github.io
...
2. [앱 설정 > 플랫폼]에 3개 플랫폼 등록:
   - Web: 사이트 도메인에 http://localhost:8080 와 https://lionandthelab.github.io 추가
   - Android: 패키지명 com.lionandthelab.nest, 키 해시 {{카카오 키 해시}}
...
2. [로그인 오픈 API 서비스 환경]에 아래 환경들을 모두 추가:
   ...
   - Android:
     패키지 이름: com.lionandthelab.nest
     다운로드 URL: https://lionandthelab.github.io/nest/ (스토어 등록 전 임시)
   - iOS:
     번들 ID: com.lionandthelab.nest
